...
//     final title = room.tag.isNotEmpty ? room.tag : 'Random connections';
//     final subtitle = room.type.isNotEmpty ? room.type : 'Room';
...
//               ),
//             ),
//             Icon(Icons.chevron_right, size: SizeConfig.blockWidth * 7),
//           ],
//         ),
//       ),
//     );
...
//   }) async {
//     // 1️⃣ Check mic permission
//     // final hasMicPermission = await _checkMicPermission();
//     // if (!hasMicPermission) {
...
//     //   ScaffoldMessenger.of(context).showSnackBar(
//     //     const SnackBar(
//     //       content: Text('User is not available for calls'),
...
//     final callId = _buildOneToOneCallID(userId, user.id);
...
//     if (mounted) {
//       _handleCurrentLocation(); // NOW safe
//     }
//   });
// }

//   void _initZegoCallInvitationService() {
//   if (_zegoCallInitDone) return;
...
//   // Optional but recommended for call audio routing
...
//         // _initZegoCallInvitationService();
...
//     await context.read<NearbyUserProvider>().fetchNearbyUsers(userId!);
...
//     try {
//       await context.read<LocationProvider>().initLocation(userId.toString());
//     } catch (_) {}
//   }
...
//                       child: ListView.separated(
//                         scrollDirection: Axis.horizontal,
//                         itemCount: nearby.users.take(3).length,
//                         separatorBuilder: (_, __) => const SizedBox(width: 6),
//                         itemBuilder: (_, index) {
//                           final u = nearby.users[index];
//                           return SizedBox(
//                             width: 140,
//                             child: _FriendCard(
//                               user: u,
...
//                     return Column(
//                       children: roomProv.rooms.reversed
//                           .take(3)
//                           .map(
//                             (r) => Padding(
//                               padding: const EdgeInsets.only(bottom: 12),
//                               child: HomeScreen._buildRoomCard(
//                                 context,
//                                 r,
//                                 userId!,
//                                 name!,
