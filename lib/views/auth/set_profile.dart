...
class _SetProfileState extends State<SetProfile> {
  ...
  void _continuePressed() {
    ...
    if (!isAgreedToTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please agree to the Privacy Policy and Terms & Conditions'),
        ),
      );
      hasError = true;
    }
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Icon(
                  hasError ? Icons.error : Icons.keyboard_arrow_down,
                ...
                child: ElevatedButton(
                  onPressed: selectedAvatarIndex != null
                      ? () async {
                          ...
                          final assetPath = avatarPaths[selectedAvatarIndex!];
                ...
                children: [
                  SizedBox(
                    ...
                    child: Checkbox(
                      ...
                      activeColor: const Color(0xFFFE0A62),
                      side: const BorderSide(
                        color: Colors.grey,
                        width: 1.5,
                      ),
